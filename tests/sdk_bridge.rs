...
fn fake_bridge_config(root: &Path) -> SdkBridgeConfig {
    ...
    fs::write(
        ...
        "{\"type\":\"module\",\"name\":\"@earendil-works/pi-coding-agent\",\"version\":\"0.85.1\",\"bin\":{\"pi\":\"dist/bundle/cli.js\"},\"exports\":{\".\":{\"import\":\"./dist/index.js\"}}}\n",
    )
...
fn bridge_negotiates_mutates_through_sdk_exports_imports_and_restarts() {
    ...
    assert_eq!(client.hello().sdk_version, "0.85.1");
