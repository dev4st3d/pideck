...
pub struct RuntimeState {
    ...
    pub queue_clear_request: Option<u64>,
    ...
    pub commands: Facet<Arc<Vec<RuntimeCommand>>>,
    pub models: Facet<Arc<Vec<ModelSummary>>>,
    pub tree: Facet<Arc<Vec<RuntimeTreeNode>>>,
    pub tree_leaf_id: Option<EntryId>,
    pub entries_leaf_id: Option<EntryId>,
    pub fork_messages: Facet<Arc<Vec<RuntimeForkMessage>>>,
    pub tools: Arc<HashMap<ToolCallId, ToolExecution>>,
...
impl RuntimeState {
    pub fn new(generation: ConnectionGeneration) -> Self {
        Self {
            ...
            queue: Arc::new(QueueContents::default()),
...
pub enum RuntimeRequest {
    ...
    ClearQueuedInputs { clear_id: u64 },
    Abort { stop_id: u64 },
    AbortBash,
    AbortRetry,
    SetModel {
